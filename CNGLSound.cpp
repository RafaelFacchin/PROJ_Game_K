...
#include <windows.h> //CONSTANTE do WINDIWS (WORD, DWORD, etc...)
#include <mmreg.h>   //COSNTANTE multimidia do windows

//---------------------------------------------------------------------------- 
// Nome: CNGLSound(CNGLSoundManager *pr_SoundManagerPam,char pc_chFileNamePam,bool bIsFXPam)
// Desc: ***CONSTRUTOR da classe de som ela já inicializa referencia pra SoundManager, Nome do Arquivo, e tipo de som
...
CNGLSound::CNGLSound(CNGLSoundManager *pr_SoundManagerPam, const char *cp_chFileNamePam, bool bIsFXPam)
{
	...
	uiDataSize       = 0; //TAMANHO dos dados (bytes)
...
// Pams: nenhum
//----------------------------------------------------------------------------
void CNGLSound::ClearSoundBuffer()
{
	if (p_Buffer)
	{
